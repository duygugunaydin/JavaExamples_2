...
calculation da
       ...
       return  price olmali.
        ...
        return turu int olmali
        Parametresi  ArrayList<String> olsun
        Eger Size "Mini" iceriyorsa price 100 ekle
        Eger Size "Middle" iceriyorsa price 200 ekle
        Eger Size "Max" iceriyorsa price 300 ekle
        return  price olmali.


DATA class

    All laptopProject.Data Metodu:
    Bu methodda laptopla ilgili tum verilere sahipsiniz.
    Parametre int
    return turu ArrayList <String>
...
FİYAT class
         ...
         Bu method, laptopProject.Data class dan AllData methodunu cagiriyor.
         LaptopID parametredir
        Bu yontemin Calculation class taki tum methodlari
        cagirmasi ve price  almasi ve totalAmount return etmesi gerekir.



        Parameter iki tane int (amount , discount) ve
        return
         tipi int olan getDiscount methodu veriliyor.
        Miktardan(amount)  indirim(discount) yapin
        indirilmli fiyati return edin
        ornek
        Amount 100
        discount 20
        20% indirimden sonra
